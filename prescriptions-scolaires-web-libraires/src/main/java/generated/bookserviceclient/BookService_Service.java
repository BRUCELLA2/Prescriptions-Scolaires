 ...
 * 
 */
@WebServiceClient(name = "BookService", targetNamespace = "http://services.prescows.form.brucella.fr/", wsdlLocation = "http://0.0.0.0:8080/prescriptions-scolaires-ws-services/services/bookService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://0.0.0.0:8080/prescriptions-scolaires-ws-services/services/bookService?wsdl");
