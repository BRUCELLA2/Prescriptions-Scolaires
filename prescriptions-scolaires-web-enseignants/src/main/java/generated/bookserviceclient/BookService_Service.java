 ...
 * 
 */
@WebServiceClient(name = "BookService", targetNamespace = "http://services.prescows.form.brucella.fr/", wsdlLocation = "http://prescriptions-scolaires-ws:8080/prescriptions-scolaires-ws-services/services/bookService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKSERVICE_QNAME = new QName("http://services.prescows.form.brucella.fr/", "BookService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://prescriptions-scolaires-ws:8080/prescriptions-scolaires-ws-services/services/bookService?wsdl");
    ...
    public BookService getBookServicePort() {
        return super.getPort(new QName("http://services.prescows.form.brucella.fr/", "BookServicePort"), BookService.class);
    }
    ...
    public BookService getBookServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.prescows.form.brucella.fr/", "BookServicePort"), BookService.class, features);
    }
